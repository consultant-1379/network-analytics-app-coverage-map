...
function Arm104nexusDeploy {
        ...
        ArtifactId=$module
        zipName=Ericsson-App-Coverage-Map
...
if [ $rsp == 0 ]; then
  git remote set-url --push origin git clone ssh://esjkadm100@gerrit.ericsson.se:29418/OSS/ENIQ-Parent/OSS/com.ericsson.eniq/network-analytics-app-coverage-map
